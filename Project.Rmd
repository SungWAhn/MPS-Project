...
# Check to see if there are any Chinese characters left
leftovers_model <- phonebrand[which(grepl('[0-9A-Za-z]', phonebrand$device_model) == FALSE), ]
leftovers_model <- leftovers_model[which(grepl('100+', leftovers$device_model)==FALSE),]
leftovers_model
```
