...
There is an issue with R not recognizing Chinese characters. Change the locale setting in read_csv to recognize Chinese characters
```{r message=FALSE}
...
### Convert device_id to int64 for efficiency
```{r}
