...
validCount48<-data.matrix(.NoNANoM[, 'count.4_8'])
validCount812<-data.matrix(.NoNANoM[, 'count.8_12'])
validCount1216<-data.matrix(.NoNANoM[, 'count.12_16'])
validCount1620<-data.matrix(.NoNANoM[, 'count.16_20'])
validCount2024<-data.matrix(.NoNANoM[, 'count.20_24'])
...
```{r}
traincateg<-cbind(training, trainingIsactive, trainingWeekday, count1216,count1620,count2024,count48,count812)
validcateg<-cbind(validation, validIsactive, validWeekday,count1216,count1620,count2024,count48,count812)
