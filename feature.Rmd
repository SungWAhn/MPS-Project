...
```{r}
training.NoNA<- training[is.na(entertainment.y)==FALSE]
validation.NoNA<-validation[is.na(entertainment.y)==FALSE]
...
- 2016-05-01 (correlated with the rest of the other dates)
