...
There is an issue with R not recognizing Chinese characters. Tried changing the locale setting in read_csv, which sort of worked.
```{r message=FALSE}
...
- phonebrand: device_id not unique, but these duplicates have exactly same rows
