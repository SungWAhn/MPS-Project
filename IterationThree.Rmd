...
### Performance
```{r results='asis'}
performancebase <-data.frame('features' = c('Count features','Count features','Count features','Count features'), 'Model' = c('NB','RF','SVM','Logistic'), 'Logloss' = c(21.09997,2.264044,2.307519,2.374288), 'Misclass' = c(0.9176875,0.7960456,0.8214055,0.8132388))
