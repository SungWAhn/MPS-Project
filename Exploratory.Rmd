...
grp_event <- data.frame('group'=grp,'Device ID Count'=grp_num,'Event ID Count'=grp_sum,'Mean Event ID Count'=grp_mean,'Median Event ID Count'=grp_median,
...
ggplot(data=groupbyevent,aes(x=group, y=percent, fill=gender))+
  geom_bar(stat="identity")+
  scale_y_continuous(labels = percent) +
...
ggplot(data=groupbydevice,aes(x=group, y = percent, fill=gender))+
  geom_bar(stat="identity")+
  scale_y_continuous(labels = percent) +
